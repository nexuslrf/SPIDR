...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--img_freq', type=int, default=10000, help='freq of rendering img during training')
        ...
        parser.add_argument('--lr',
                            ...
                            default=0.001,
                            help='initial learning rate')
        parser.add_argument('--elr', type=float, default=0)
        parser.add_argument('--blr', type=float, default=0)
        ...
        parser.add_argument('--prune_thresh',
                            type=float,
                            default=-1)
        parser.add_argument('--sdf_prune_thresh', type=float, default=0)
        parser.add_argument('--sdf_prune_thresh_decay', type=float, default=1.)
        parser.add_argument('--sdf_prune_thresh_k', type=float, default=0)
        parser.add_argument('--vox_growing_thresh', type=float, default=0)
        parser.add_argument('--vox_growing_iter', type=int, default=0)
        parser.add_argument('--prob_max_iter', type=int, default=9999999)
        ...
        parser.add_argument('--prune_max_iter',
                            type=int,
                            default=9999999)
        parser.add_argument('--prune_min_iter', type=int, default=0)
